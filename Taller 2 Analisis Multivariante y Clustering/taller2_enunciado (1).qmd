...
```{r}
library(readr)
datos_taller_evaluado_2 <- readr::read_csv("datos_taller_evaluado_2.csv")
...
```{r}
library(readr)
perfil_Edu <- readr::read_csv("perfil_Edu.csv")
head(perfil_Edu)
```
...
##### Bloque A
```{r}
datos <- readr::read_csv("datos_taller_evaluado_2.csv")
...
perfil <- readr::read_csv("perfil_Edu.csv")$x
